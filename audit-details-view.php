...
<body>
  ...
  <div class="container">
    ...
    ?>
    <a href="view-gmp.php" class="btn btn-secondary mb-3">Back</a>
...
<table class="table table-hover text-center">
    ...
    <tbody>
        ...
        // $query="SELECT * FROM ans1";
        // $query ="select * from ans1 ";
        $query = "SELECT * FROM tblsaveans WHERE sno = '$sno'";
        // $query ="select .*from";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <tr>
                ...
                <td>
                    <a href="assets/suppdoc/<?php echo $row['pic']; ?>" class="your-class-here">
                        <?php echo "Click here for Open Document"?>
                    </a>
