...
<?php include "connect.php";?>
  <div class="container">
    ...
    ?>
    <a href="add-audit.php" class="btn btn-secondary mb-3">Back</a>
    <a href="index.php" class="btn  btn-primary mb-3">Home</a>
    <a href="auditt-management.php" class="btn  btn-primary mb-3">form</a>
...
<table class="table table-hover text-center">
    ...
    <h1 class="p-3">Audit Details || Audit Management</h1>
        <tr>
            <th>ID</th>
            <th>Date</th>
            <th> Username/Auditee</th>
            <!-- <th> Auditee-username</th> -->
            <!-- <th>Auditee2</th> -->
            <th>Auditee</th>
            <th>Auditor</th>
            <th>Audit</th>
...
if (isset($_SESSION['username'])) {
    $username = $_SESSION['username'];
    echo "this session value is " . $username;
} else {
    echo "the session is not set.";
}

// In your login script after successful login
// Validate user's login credentials and get their username
...
//     echo "You are logged in as user2";
// }
// ====================================================================
...
// Check if the user is logged in and identify the user
...
if (isset($_SESSION['username'])) {
    ...
    // Control access based on the username
    if ($username === 'user1') {
        // Allow access for user1
        // Your code for user1 goes here
        echo "This is content for user1";
    } elseif ($username === 'user2') {
        // Allow access for user2
        // Your code for user2 goes here
        echo "This is content for user2";
    }
} else {
...
// using the session variable 
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <tr>
                ...
                <td>
                    <a href="audit-view-details.php?id=<?php echo $row["id"]; ?>" class="fa-solid fa-eye fs-5"></a>
                </td>
        ...
        // Close your database connection here if it's not done elsewhere
        ?>
...
// SQL query to retrieve 'sno' and 'ans' from the database
// $query = "SELECT sno, ans FROM ans1";
// Execute the query
...
if ($results) {
    while ($row = mysqli_fetch_assoc($results)) {
        ...
        // Output the results
        // echo "For sno $sno, Audit Status: $auditStatus<br>";
    }
