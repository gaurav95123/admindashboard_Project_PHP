...
//     $sql = "SELECT * FROM auditor_management WHERE id = $id";
...
<head>
    ...
    <title>view auditor management</title>
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    <!-- ============================================================== -->
                    <h1 class="p-3">View Auditor Details</h1>
...
?>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <img src="<?php echo $row['aphoto']; ?>" width="200" >
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                value="<?php echo $row['contact']; ?>" autocomplete="off" class="form-control" disabled>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="inputPDF">Certificate</label>
                                                    <br>

                                                    <iframe src='<?php echo $row['acertificate']; ?>' width="100%" height="500" frameborder="0"></iframe>

                                                <!-- <iframe src='assets/certificates/<?php echo $row['acertificate']; ?>' width="100%" height="500" frameborder="0"></iframe> -->
                                            </div>
