...
if (isset($_POST["submit"])) {
    ...
    for ($i = 0; $i < count($_POST['qqid']); $i++) {
        ...
        // Access the radio button value by name
        ...
        $sql = "INSERT INTO tblsaveans (qqid, quess, ans, cmnt, pic, sno)

                VALUES ('$qqid', '$quess', '$ans', '$cmnt', '$pic','$sno')";
                                                        ...
                                                        <div class="form-control">
                                                            ...
                                                            <div class="radio-buttons-horizontal ml-3 mb-3">
                                                                ...
                                                                <label class="custom-control custom-radio custom-control-inline">
                                                                    ...
                                                                    <input type="radio" name="r1<?php echo $i; ?>" class="custom-control-input" value="a">
                                                                ...
                                                                <label class="custom-control custom-radio custom-control-inline">
                                                                    ...
                                                                    <input type="radio" name="r1<?php echo $i; ?>" class="custom-control-input" value="b">
                                                                ...
                                                                <label class="custom-control custom-radio custom-control-inline">
                                                                    ...
                                                                    <input type="radio" name="r1<?php echo $i; ?>" class="custom-control-input" value="c">
                                                                ...
                                                                <label class="custom-control custom-radio custom-control-inline">
                                                                    ...
                                                                    <input type="radio" name="r1<?php echo $i; ?>" class="custom-control-input" value="d">
