                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fa fa-fw fa-user"></i> Admin Dashboard <span class="badge badge-success">6</span></a>
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                       
                                        <li class="nav-item">
                                            <a class="nav-link" href="trainer-managment.php">Trainer Management</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="auditor-management.php">Auditor Management</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="user-managment.php">User Management</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="add-gmp.php">Salsa Module</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="add-audit.php">Audit Management</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
