<!-- nav bar login user login show button start -->
...
<body>
  ...
  <div class="container">
    ...
    ?>
    <a href="trainer-managment-add.php" class="btn btn-secondary mb-3">Add New</a>
...
<table class="table table-hover text-center">
  <thead class="table-light">
    <h1 class="p-3">Trainer Details</h1>
    <tr>
      <th>ID</th>
      <th>Name</th>
      <th>Email</th>
  ...
  <tbody>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
      ...
      <tr>
        ...
        <td>
          <a href="trainer-managment-update.php?id=<?php echo $row["id"]; ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
        </td>
        <td>
          <a href="trainer-managment-view.php?id=<?php echo $row["id"]; ?>" class="fa-solid fa-eye fs-5"></a>
        </td>
        <td>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    deleteButtons.forEach(button => {
        button.addEventListener("click", function() {
            ...
            if (confirmDelete) {
                window.location.href = "trainer-managment-delete.php?id=" + recordId;
            }
        });
    });
});
