    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            ...
            <!-- <a href="audit-details.php" class="btn btn-secondary mt-3 ml-4 mb-3">View Audit Details</a> -->
                <a href="view-audit-details.php" class="btn  btn-secondary  mt-3 ml-4 mb-3">View details</a>
                <div class="container-fluid dashboard-content ">
                    <!-- ============================================================== -->
                    <h1 class="p-3"> Add Audit||Audit Management</h1>
...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO  audit_management (dates, auditee, audit, auditor) VALUES ('$date', '$auditee', '$audit', '" . $_SESSION['username'] . "')";


    $result = mysqli_query($conn, $sql);

     $sql1="SELECT * from audit_management where date='$date' and  auditee='$auditee' and audit='$audit' order by id desc limit 1";
...
// ================================================================================================
    // header("Location: questions-page.php?msg=New record created successfully&sno= '$sno' ");
// header("Location: questions-page.php?msg=New record created successfully&sno=$sno ");
// header("Location: questions-page.php?msg=New record created successfully");
header("Location: audit-questions-page.php?msg=New record created successfully&sno=$sno ");
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="" id="basicform"
                                            ...
                                            <div class="form-group">
                                            <label for="auditee">Auditee Name:</label>
