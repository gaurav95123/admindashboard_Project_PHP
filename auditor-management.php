...
<body>
  ...
  <div class="container">
    ...
    ?>
    <a href="auditor-management-add.php" class="btn btn-secondary mb-3">Add New</a>
    <a href="index.php" class="btn  btn-primary mb-3">Home</a>
<table class="table table-hover text-center">
  <thead class="table-light">
    <h1 class="p-3">Auditor Details</h1>
    <tr>
      <th>Id</th>
      <th>Name</th>
      <th>Username</th>
  ...
  <tbody>
    <?php
    $sql = "SELECT * FROM `auditor_management`";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
      ...
      <tr>
        ...
        <td>
          <a href="auditor-management-update.php?id=<?php echo $row["id"]; ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
        </td>
        <td>
          <a href="auditor-management-view.php?id=<?php echo $row["id"]; ?>" class="fa-solid fa-eye fs-5"></a>
        </td>
        <td>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    deleteButtons.forEach(button => {
        button.addEventListener("click", function() {
            ...
            if (confirmDelete) {
                window.location.href = "auditor-management-delete.php?id=" + recordId;
            }
        });
    });
});
